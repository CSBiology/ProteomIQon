...
let defaultLabeledQuantificationParams :Dto.LabeledQuantificationParams = 
    ...
    {
        Correlation_Light_Heavy_Threshold    = Some 0.9
...
System.IO.File.WriteAllText(__SOURCE_DIRECTORY__ + @"/../defaultParams\LabeledQuantificationParams_withCorrFilter.json",serialized)

let deserialized = 
    System.IO.File.ReadAllText(__SOURCE_DIRECTORY__ + @"/../defaultParams\LabeledQuantificationParams_withCorrFilter.json")
