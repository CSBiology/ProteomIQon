...
System.IO.File.WriteAllText(__SOURCE_DIRECTORY__ + @"/../defaultParams\LabelFreeQuantificationParams_ChargeAgg.json",serialized)

let deserialized = 
    System.IO.File.ReadAllText(__SOURCE_DIRECTORY__ + @"/../defaultParams\LabelFreeQuantificationParams_ChargeAgg.json")
