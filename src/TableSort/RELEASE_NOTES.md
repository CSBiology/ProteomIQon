...
* Update to .NET 10
* Update NLog to 4.7.11, BioFSharp to 2.0.0, FSharpAux to 2.1.0, FSharp.Stats to 0.6.0, System.Data.SQLite.Core to 1.0.119 and Plotly.NET to 6.0.0-preview.2
