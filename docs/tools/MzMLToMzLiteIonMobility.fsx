...
It is the ion mobility counterpart of [MzMLToMzLite]({{root}}tools/MzMLToMzLite.html), which also explains how to get mzML from raw files and what mzlite is.
...
The wavelet parameters are explained on the [MzMLToMzLite]({{root}}tools/MzMLToMzLite.html) page. The default file is [TIMsMzMLtoMzLiteParams.json](https://github.com/CSBiology/ProteomIQon/blob/dev/src/ProteomIQon/defaultParams/TIMsMzMLtoMzLiteParams.json).
