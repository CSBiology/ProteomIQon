(**
// can't yet format YamlFrontmatter (["title: QuantBasedAlignment"; "category: Tools"; "categoryindex: 1"; "index: 8"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
...
**Disclaimer** this tool needs [quantified peptides](https://csbiology.github.io/ProteomIQon/tools/PSMBasedQuantification.html) files.
